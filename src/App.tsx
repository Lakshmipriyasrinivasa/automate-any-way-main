...
import FieldWorkForm from "@/components/FieldworkForm";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/scheduling" element={<Layout title="Scheduling"><div><h1 className="text-2xl font-bold">Scheduling - Coming Soon</h1></div></Layout>} />
