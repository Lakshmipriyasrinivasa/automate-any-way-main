...
const WorkOrderForm: React.FC = () => {
  ...
  // Fetch dropdown data
 useEffect(() => {
  axios.get("http://localhost:5000/api/work_orders/types")
    .then(res => setTypes(res.data))
    .catch(err => console.error("❌ Failed to fetch types", err));

  axios.get("http://localhost:5000/api/work_orders/statuses")
    .then(res => setStatuses(res.data))
    .catch(err => console.error("❌ Failed to fetch statuses", err));

  axios.get("http://localhost:5000/api/work_orders/priorities")
    .then(res => setPriorities(res.data))
