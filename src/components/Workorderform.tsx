...
//   // Fetch dropdown data
//  useEffect(() => {
//   axios.get("http://localhost:5000/api/work_orders_types")
//     .then(res => setTypes(res.data))
//     .catch(err => console.error("❌ Failed to fetch types", err));

//   axios.get("http://localhost:5000/api/work_orders_statuses")
//     .then(res => setStatuses(res.data))
//     .catch(err => console.error("❌ Failed to fetch statuses", err));

//   axios.get("http://localhost:5000/api/work_orders_priorities")
//     .then(res => setPriorities(res.data))
//     .catch(err => console.error("❌ Failed to fetch priorities", err));
// }, []);
